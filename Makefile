...
TEST_SOURCES += test/PartitionTest.cpp
...
# TODO replace this with autogenerated dependencies with -M* flags
src/dstruct/factor_graph/factor_graph.cpp src/gibbs.cpp src/app/gibbs/gibbs_sampling.cpp src/io/cmd_parser.cpp: src/io/cmd_parser.h
